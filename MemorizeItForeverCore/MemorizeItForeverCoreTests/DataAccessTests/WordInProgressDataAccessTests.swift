...
class WordInProgressDataAccessTests: XCTestCase {
    ...
    override func setUp() {
        ...
        let genericDataAccess = MockGenericDataAccess<WordInProgressEntity>(context: context)
        let wordDataAccess = MockGenericDataAccess<WordEntity>(context: context)
        wordInProgressDataAccess = WordInProgressDataAccess(genericDataAccess: genericDataAccess, wordDataAccess: wordDataAccess)
    }
