...
class WordHistoryDataAccessTests: XCTestCase {
    ...
    override func setUp() {
        ...
        let genericDataAccess = MockGenericDataAccess<WordHistoryEntity>(context: context)
        let wordDataAccess = MockGenericDataAccess<WordEntity>(context: context)
        wordHistoryDataAccess = WordHistoryDataAccess(genericDataAccess: genericDataAccess, wordDataAccess: wordDataAccess)
    }
