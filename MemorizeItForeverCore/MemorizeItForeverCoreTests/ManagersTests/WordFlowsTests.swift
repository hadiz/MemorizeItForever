...
//    var wordFlowManager: WordFlowManager!
...
//            wordFlowManager.answerCorrectly(wordInProgressesModel)
//            let wordInProgresses = try wordInProgressDataAccess.fetchAll()
...
//            try wordInProgressDataAccess.save(inProgressModel)
//            let wordInProgressesModel = try wordInProgressDataAccess.fetchAll()[0]
//            wordFlowManager.answerWrongly(wordInProgressesModel)
////            let wordInProgresses = try wordInProgressDataAccess.fetchAll()
...
//            wordFlowManager.answerWrongly(inProgress)
//            _ = newWordModel(context)
//            try wordFlowManager.fetchNewWordsToPutInPreColumn()
//            
//            let wordInProgress = try wordInProgressDataAccess.fetchAll()
...
//            try wordFlowManager.fetchNewWordsToPutInPreColumn()
//            let inProgress = try wordInProgressDataAccess.fetchAll()[0]
//            wordFlowManager.answerCorrectly(inProgress)
...
//            wordFlowManager.answerCorrectly(inProgress1)
//            wordFlowManager.answerWrongly(inProgress2)
//            _ = newWordModel(context)
//            try wordFlowManager.fetchNewWordsToPutInPreColumn()
